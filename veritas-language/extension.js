...
const hoverData = {
    ...
    'Include': "Includes a Veritas file (.ver) or a C library/header. Syntax: Include 'file.ver' or Include the library 'stdio.h'.",
    'Define dimension': "Defines a new physical dimension. Syntax: Define dimension 'Length'.",
    'Define unit': "Defines a base or derived unit. Syntax: Define unit 'meter' for 'Length' with symbol \"m\".",
    ...
    'Create': "Declares a new variable, array, vector, or matrix. Syntax: Create 'name' as a type<unit> [vector/array of size N] [with value val].",
    'Export': "Exports a variable for reporting. Syntax: Export 'name' as 'Label' for report.",
